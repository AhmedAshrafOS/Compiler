            ...
            private static IDictionary<string, List<string>> keywords = new Dictionary<string, List<string>>()
        {
                ...
                while (Index < Code.Length)
                {
                    ...
                    if (isWhiteSpace(Code[Index]))
                    {
                        if (Code[Index] == '\n')
                        {
                            ...
                            Line++;  //Console.WriteLine("yaaa im in \n");
                        }
                        Index++;
                        // Console.WriteLine("yaaa im in space");
                        i++;
                    }
                    else
                    {
                        //Console.WriteLine("im hereeeeeeeeeeeeeeeee2");
                        //Console.WriteLine(Code[Index]);
                        a = ReturnComment();
                        //   Console.WriteLine("comment:"+a.Text + "the index is" + Index);
                        if (a.Text != "fail")
                        {
                            a.LineNum = Line;
                        ...
                        a = ReturnKeywords();
                        // Console.WriteLine("keyword:" + a.Text + "the index is" + Index);
                        if (a.Text != "fail")
                        {
                            a.LineNum = Line;
                            tokens.Add(a); Index++;
                        ...
                        a = ReturnIdentifier();
                        //Console.WriteLine("id:" + a.Text + "the index is" + Index);
                        if (a.Text != "fail")
                        {
                            a.LineNum = Line;
                            tokens.Add(a); Index++;
                        ...
                        a = ReturnSymoble();
                        // Console.WriteLine("symbole:" + a.Text+"the index is"+Index);
                        if (a.Text != "fail")
                        {
                            a.LineNum = Line;
                            tokens.Add(a); Index++;
                        ...
                        a = ReturnConstant();
                        //Console.WriteLine("constant:" + a.Text + "  the index is" + Index);
                        if (a.Text != "fail")
                        {
                            a.LineNum = Line;
                            tokens.Add(a); Index++;
            ...
            public static List<string> DisplayTokens(string code)
            {
                ...
                foreach (var i in y)
                {
                    ...
                    {
                        NumOfError++;
                    Tok.Add("Line#:{0} Error in Token Text:{1}" + i.LineNum + i.Text);
                        //Console.WriteLine("Line#:{0} Error in Token Text:{1}", i.LineNum, i.Text);
                    }
                    else
                    {
                    Tok.Add("Line#:{0}  Token Text:{1}   Token Type:{2} " + i.LineNum+ i.Text +i.Type);

                    //Console.WriteLine("Line#:{0}  Token Text:{1}   Token Type:{2} ", i.LineNum, i.Text, i.Type);
                    }
                }
            if (Tok.Count != 0)
            {
            ...
            {
                Tok.Add("Total NO of errors:{0}" + NumOfError);
                    return Tok;
            }
            //Console.WriteLine("Total NO of errors:{0}", NumOfError);
            }
